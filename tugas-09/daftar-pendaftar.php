        ...
        <table class="table table-striped" style="background-color: rgba(255, 255, 255, 0.5)">
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)){
                    ...
                    echo "<a class='btn btn-warning' style='margin-right: 1rem' href='/tugas-09/form-edit.php?id=".$siswa['id']."'>Edit</a>";
                    echo "<a class='btn btn-danger' href='/tugas-09/hapus-pendaftar.php?id=".$siswa['id']."'>Hapus</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
